...
-- =============================================================
-- SEED DATA
-- One admin, one regular user for testing
-- Passwords below are bcrypt hashes of:
--   admin123  → admin account
--   user123   → regular user account
-- Replace these hashes with ones generated by your AuthService
-- =============================================================
INSERT INTO users (username, email, password_hash, role) VALUES
('admin',    'admin@taskvault.com', 'REPLACE_WITH_BCRYPT_HASH', 'Admin'),
('testuser', 'user@taskvault.com',  'REPLACE_WITH_BCRYPT_HASH', 'User');

INSERT INTO tasks (user_id, title, description, status) VALUES
(2, 'Setup project repo', 'Initialize Git and folder structure',  'Done'),
(2, 'Build login page',   'HTML form posting to /api/auth/login', 'InProgress'),
(2, 'Write STRIDE table', 'Document all 6 threat categories',     'Pending');
GO